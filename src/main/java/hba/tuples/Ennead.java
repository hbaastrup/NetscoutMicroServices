...
public class Ennead<A,B,C,D,E,F,G,H,I> extends Tuple {
	public Ennead(A arg0, B arg1, C arg2, D arg3, E arg4, F arg5, G arg6, H arg7, I arg8) {
		values.put(0, arg0);
		values.put(1, arg1);
		values.put(2, arg2);
		values.put(3, arg3);
	...
	public Type getType() {return Type.ENNEAD;}
